...
export default function LeftBar({ songs, currentSong, setCurrentSong, searchQuery }: LeftBarProps) {
  ...
  const sortedSongs = [
    currentSong,
    ...filteredSongs.filter(song => song !== currentSong)
  ];
    ...
    <div className="bg-black text-white font-semibold flex flex-col w-full sm:w-64 lg:w-80 h-full">
      ...
      <div className="bg-[#121212] rounded-lg mx-2 mt-2 flex flex-col gap-4 overflow-y-auto max-h-[calc(100vh-64px)]">
        ...
        <div className="flex justify-between items-center px-4 py-3">
          <div className="text-gray-500 cursor-pointer hover:text-white transition duration-300 text-base">
            Your Library
          </div>
